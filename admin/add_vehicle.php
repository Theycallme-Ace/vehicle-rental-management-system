...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            // Insert vehicle
            $stmt = $pdo->prepare("INSERT INTO vehicles (vehicle_name, vehicle_type, year, license_plate, 
                                                       passenger_capacity, daily_rate, gps_unit_id, description, 
            ...
            $stmt->execute([
                ...
                $image_path ?: null, $_SESSION['user_id']
            ]);

            $vehicle_id = $pdo->lastInsertId();

            // Insert vehicle facilities
...
<div class="min-h-screen bg-gray-100">
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Add Vehicle Form -->
            <div class="mt-8">
                <form action="/admin/add_vehicle.php" method="POST" enctype="multipart/form-data" class="space-y-8">
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" 
                                           name="vehicle_name" 
                                           id="vehicle_name"
                                           value="<?php echo htmlspecialchars($_POST['vehicle_name'] ?? ''); ?>"
                                           required
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input type="number" 
                                           ...
                                           min="1"
                                           value="<?php echo htmlspecialchars($_POST['passenger_capacity'] ?? ''); ?>"
                                           required
                                           class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" 
                                           name="gps_unit_id" 
                                           id="gps_unit_id"
                                           value="<?php echo htmlspecialchars($_POST['gps_unit_id'] ?? ''); ?>"
                                           class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                ...
                                <div class="col-span-6">
                                    ...
                                    <textarea name="description" 
                                              id="description"
                                              rows="4"
                                              class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
                                </div>
                            </div>
                        </div>
